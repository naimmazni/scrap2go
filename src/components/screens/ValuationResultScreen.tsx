...
const ValuationResultScreen: React.FC = () => {
  ...
  return (
    <PageContainer>
      ...
      {/* Main Content */}
      <ContentArea>
        {/* FIX: Wrapped content in a div with explicit padding.
           This ensures spacing works even if ContentArea ignores style props.
        */}
        <div style={{ padding: theme.spacing.md, width: '100%' }}>
